...
import StartRattig from './StartRattig';
...
const Star = ({ filled }) => (
  ...
  return (
    ...
    <Title  title='What are Guest Say'  subtitle='Discover why discerning travelers consistenly choose quickstay for their exclusive and luxirous accomodation around the world'/>
            <div className="flex flex-wrap items-center justify-center gap-8 mt-10 mb-10">
                {testimonials.map((testimonial) => (
                    <div key={testimonial.id} className="bg-white p-6 py-10 rounded-xl shadow max-w-lg">
